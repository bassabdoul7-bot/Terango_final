...
function ActiveRideScreen(props) {
  ...
  function getActionButton(){
    ...
    switch(ride.status){
      ...
      case 'arrived':
        return (<View>
          {ride.paymentMethod === 'wave' && <View style={styles.waveBanner}><Text style={styles.waveBannerIcon}>{'\uD83C\uDF0A'}</Text><Text style={styles.waveBannerText}>{'Le passager doit payer ' + (ride.fare ? ride.fare.toLocaleString() : '0') + ' FCFA par Wave'}</Text></View>}
