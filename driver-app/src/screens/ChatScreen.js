...
var styles = StyleSheet.create({
  ...
  emptyIcon: { fontSize: 48, marginBottom: 12 , fontFamily: 'LexendDeca_400Regular' },
  emptyText: { fontSize: 15, color: COLORS.textDarkMuted , fontFamily: 'LexendDeca_400Regular' },
