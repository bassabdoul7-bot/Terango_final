    ...
    <SafeAreaView style={styles.container}>
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} keyboardVerticalOffset={0}>
        <View style={styles.inputRow}>
          <TextInput style={styles.input} value={inputText} onChangeText={setInputText} placeholder="Votre message..." placeholderTextColor={COLORS.textDarkMuted} maxLength={500} multiline={false} returnKeyType="send" onSubmitEditing={handleSend} />
...
var styles = StyleSheet.create({
  ...
  emptyText: { fontSize: 15, color: COLORS.textDarkMuted },
  ...
  input: { flex: 1, backgroundColor: COLORS.background, borderRadius: 24, paddingHorizontal: 18, paddingVertical: 12, fontSize: 15, color: COLORS.textDark, marginRight: 10, borderWidth: 1, borderColor: COLORS.grayLight },
