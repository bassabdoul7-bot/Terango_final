...
var styles = StyleSheet.create({
  ...
  tierCard: { backgroundColor: COLORS.darkCard, borderRadius: 16, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: COLORS.darkCardBorder, elevation: 4 },
  tierCardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 },
  tierCardTitle: { fontSize: 16, fontFamily: 'LexendDeca_700Bold', color: '#FFFFFF' },
  ...
  earningsHeroValue: { fontSize: 48, fontFamily: 'LexendDeca_700Bold', color: COLORS.textLight },
  earningsHeroCurrency: { fontSize: 18, fontFamily: 'LexendDeca_600SemiBold', color: COLORS.textLightSub, marginLeft: 8, marginBottom: 8 },
  ...
  progressLabel: { fontSize: 12, color: COLORS.textLightMuted , fontFamily: 'LexendDeca_400Regular' },
  ...
  weeklyTitle: { fontSize: 16, fontFamily: 'LexendDeca_600SemiBold', color: COLORS.textLight },
  weeklyTotal: { fontSize: 16, fontFamily: 'LexendDeca_700Bold', color: COLORS.yellow },
  weeklySubtitle: { fontSize: 12, color: COLORS.textLightMuted, marginBottom: 20, marginTop: 4 , fontFamily: 'LexendDeca_400Regular' },
  ...
  barDay: { fontSize: 11, color: COLORS.textLightMuted , fontFamily: 'LexendDeca_400Regular' },
  ...
  vehicleName: { fontSize: 22, fontFamily: 'LexendDeca_700Bold', color: COLORS.textLight, marginBottom: 4 },
  vehiclePlate: { fontSize: 16, color: COLORS.textLightMuted, fontFamily: 'LexendDeca_600SemiBold' },
