...
var styles = StyleSheet.create({
  ...
  tierName: { fontSize: 12, fontWeight: '700', marginRight: 6 },
  tierRate: { fontSize: 11, fontWeight: '600' },
  ...
  tierCardTitle: { fontSize: 16, fontWeight: 'bold', color: '#FFFFFF' },
  tierCardRate: { fontSize: 14, fontWeight: '700' },
  ...
  tierMaxText: { fontSize: 14, color: '#FCD115', fontWeight: '600' },
  tierBadge: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10, marginTop: 4, alignSelf: 'flex-start' },
  tierIcon: { fontSize: 12, marginRight: 4 },
  tierName: { fontSize: 12, fontWeight: '700', marginRight: 6 },
  tierRate: { fontSize: 11, fontWeight: '600' },
