...
var styles = StyleSheet.create({
  ...
  emptyText: { fontSize: 15, color: '#999' , fontFamily: 'LexendDeca_400Regular' },
  ...
  input: { flex: 1, backgroundColor: COLORS.background, borderRadius: 24, paddingHorizontal: 18, paddingVertical: 12, fontSize: 15, color: '#1A1A1A', marginRight: 10, borderWidth: 1, borderColor: '#E5E5E5' , fontFamily: 'LexendDeca_400Regular' },
