...
var styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, color: COLORS.textDark, fontSize: 15, paddingVertical: 14 , fontFamily: 'LexendDeca_400Regular' },
  clearIcon: { fontSize: 16, color: COLORS.textDarkMuted, padding: 4 , fontFamily: 'LexendDeca_400Regular' },
  ...
  retryBtnText: { fontSize: 15, fontFamily: 'LexendDeca_700Bold', color: COLORS.darkBg },
  ...
  restoImageEmoji: { fontSize: 48 , fontFamily: 'LexendDeca_400Regular' },
  ...
  closedText: { fontSize: 18, fontFamily: 'LexendDeca_700Bold', color: '#fff' },
  ...
  featuredText: { fontSize: 11, fontFamily: 'LexendDeca_700Bold', color: COLORS.darkBg },
  restoInfo: { padding: 16 },
  restoNameRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 6 },
  restoName: { fontSize: 18, fontFamily: 'LexendDeca_700Bold', color: COLORS.textDark, flex: 1 },
  ...
  restoStars: { fontSize: 12, color: COLORS.yellow, marginRight: 4 , fontFamily: 'LexendDeca_400Regular' },
  restoRating: { fontSize: 13, fontFamily: 'LexendDeca_600SemiBold', color: COLORS.textDark, marginRight: 6 },
  restoDot: { color: COLORS.textDarkMuted, marginRight: 6 },
  restoTime: { fontSize: 13, color: COLORS.textDarkSub , fontFamily: 'LexendDeca_400Regular' },
  ...
  cuisineText: { fontSize: 11, color: COLORS.textDarkSub , fontFamily: 'LexendDeca_400Regular' },
  restoFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  restoMin: { fontSize: 12, color: COLORS.textDarkMuted , fontFamily: 'LexendDeca_400Regular' },
  restoDelivery: { fontSize: 12, color: COLORS.green, fontFamily: 'LexendDeca_500Medium' },
});
