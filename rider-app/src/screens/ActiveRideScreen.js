...
const styles = StyleSheet.create({
  ...
  contactLabel: { fontSize: 11, fontWeight: '500', color: COLORS.textLightSub },
  fareTag: { alignItems: 'flex-end' },
  fareTagAmount: { fontSize: 18, fontWeight: 'bold', color: COLORS.yellow },
  ...
  pinCode: { fontSize: 28, fontWeight: 'bold', color: COLORS.yellow, letterSpacing: 8, textAlign: 'center' },
