...
var styles = StyleSheet.create({
  ...
  noDriverCard: { position: 'absolute', top: height * 0.25, left: 30, right: 30, backgroundColor: '#FFFFFF', borderRadius: 24, padding: 30, alignItems: 'center', borderWidth: 1, borderColor: '#EEF0F3' },
  noDriverTitle: { fontSize: 20, fontFamily: 'LexendDeca_700Bold', color: '#1A1A1A', marginBottom: 8 },
  ...
  bottomCard: { position: 'absolute', bottom: 30, left: 16, right: 16, backgroundColor: '#FFFFFF', borderRadius: 20, padding: 16, borderWidth: 1, borderColor: '#EEF0F3' },
  ...
  fareLabel: { fontSize: 13, color: '#757575', fontFamily: 'LexendDeca_600SemiBold' },
  ...
  modalCard: { backgroundColor: '#FFFFFF', borderRadius: 24, padding: 30, width: width - 60, alignItems: 'center', borderWidth: 1, borderColor: '#EEF0F3' },
  modalTitle: { fontSize: 20, fontFamily: 'LexendDeca_700Bold', color: '#1A1A1A', marginBottom: 8 },
  modalSub: { fontSize: 14, color: '#757575', marginBottom: 24, textAlign: 'center' , fontFamily: 'LexendDeca_400Regular' },
