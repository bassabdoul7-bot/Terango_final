...
const styles = StyleSheet.create({
  ...
  autocompleteInput: { fontSize: 16, color: COLORS.textLight, paddingVertical: 12, paddingHorizontal: 16, backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' , fontFamily: 'LexendDeca_400Regular' },
  ...
  recentIcon: { fontSize: 20 , fontFamily: 'LexendDeca_400Regular' },
  recentTextContainer: { flex: 1 },
  recentAddress: { fontSize: 16, fontFamily: 'LexendDeca_600SemiBold', color: COLORS.textDark, marginBottom: 4 },
  recentSubtext: { fontSize: 14, color: COLORS.textDarkMuted , fontFamily: 'LexendDeca_400Regular' },
});
