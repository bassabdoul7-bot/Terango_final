        ...
        <View style={styles.profileSection}>
          ...
          <View style={styles.profileGroup}>
            <TouchableOpacity style={styles.profileRow} onPress={function(){Linking.openURL('https://wa.me/221784256407');}}>
              ...
              <View style={{flex:1}}><Text style={styles.profileLabel}>WhatsApp Senegal</Text><Text style={{fontSize:12,color:COLORS.textDarkMuted,fontFamily:'LexendDeca_400Regular'}}>+221 78 425 64 07</Text></View>
            </TouchableOpacity>
            <TouchableOpacity style={styles.profileRow} onPress={function(){Linking.openURL('https://wa.me/17047263959');}}>
              <Text style={{fontSize:18,marginRight:12}}>{'\uD83D\uDCAC'}</Text>
              <View style={{flex:1}}><Text style={styles.profileLabel}>WhatsApp US</Text><Text style={{fontSize:12,color:COLORS.textDarkMuted,fontFamily:'LexendDeca_400Regular'}}>+1 704 726 3959</Text></View>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.profileRow,{borderBottomWidth:0}]} onPress={function(){Linking.openURL('mailto:contact@terango.sn');}}>
              <Text style={{fontSize:18,marginRight:12}}>{'\uD83D\uDCE7'}</Text>
              <View style={{flex:1}}><Text style={styles.profileLabel}>Email</Text><Text style={{fontSize:12,color:COLORS.textDarkMuted,fontFamily:'LexendDeca_400Regular'}}>contact@terango.sn</Text></View>
            </TouchableOpacity>
          </View>
        </View>
...
var styles = StyleSheet.create({
  ...
  driverCountBadge: {
    ...
    backgroundColor: 'rgba(212,175,55,0.7)', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20,
    borderWidth: 1.5, borderColor: 'rgba(212,175,55,0.4)',
  },
  driverCountText: { color: COLORS.darkBg, fontSize: 13, fontFamily: 'LexendDeca_600SemiBold' },
